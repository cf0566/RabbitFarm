...
public class ChatAllHistoryFragment extends Fragment {
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		// 更新消息未读数
		((EaseMobMainActivity) getActivity()).updateUnreadLabel();
	...
	public void onResume() {
		super.onResume();
		if (!hidden && ! ((EaseMobMainActivity)getActivity()).isConflict) {
			refresh();
		}
	}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((EaseMobMainActivity)getActivity()).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((EaseMobMainActivity)getActivity()).getCurrentAccountRemoved()){
