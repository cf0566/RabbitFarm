...
public class ChatActivity extends BaseActivity implements OnClickListener, EMEventListener{
	...
	private String toUserAliasName;
	...
	private void setUpView() {
		...
		if (chatType == CHATTYPE_SINGLE) { // 单聊
			...
			toUserAliasName=getIntent().getStringExtra("userNick");
			toUserImg=getIntent().getStringExtra("userImg");
			((TextView) findViewById(R.id.name)).setText(toUserAliasName);
			 conversation =
