...
public class EaseMobMainActivity extends BaseActivity implements EMEventListener{
...
//		MobclickAgent.setDebugMode( true );
   ...
   @Override
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (ChatActivity.activityInstance != null && usernameList.contains(ChatActivity.activityInstance.getToChatUsername())) {
						Toast.makeText(EaseMobMainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, 1).show();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(error == EMError.USER_REMOVED){
                        ...
                        if (NetUtils.hasNetwork(EaseMobMainActivity.this))
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (currentTabIndex == 0)
                        chatHistoryFragment.refresh();
                    if (CommonUtils.getTopActivity(EaseMobMainActivity.this).equals(GroupsActivity.class.getName())) {
	...
	private void showConflictDialog() {
		...
		if (!EaseMobMainActivity.this.isFinishing()) {
			// clear up global variables
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(EaseMobMainActivity.this);
				...
				conflictBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						conflictBuilder = null;
						finish();
						startActivity(new Intent(EaseMobMainActivity.this, LoginActivity.class));
					}
				});
		...
		if (!EaseMobMainActivity.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(EaseMobMainActivity.this);
