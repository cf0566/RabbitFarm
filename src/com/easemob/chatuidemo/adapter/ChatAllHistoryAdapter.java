...
//		    UserUtils.setUserAvatar(getContext(), userImg, holder.avatar);
			loadUserInfo(userid,holder.avatar,holder.name);
			if (userid.equals(Constant.GROUP_USERNAME)) {
				holder.name.setText("群聊");

			} else if (userid.equals(Constant.NEW_FRIENDS_USERNAME)) {
	...
	public void loadUserInfo(String user_id,final ImageView iv,final TextView tv){
		post = new HttpUtils();
		params = new RequestParams();
		String url = UrlUtils.postUrl+UrlUtils.path_getEaseInfo;
		params.addBodyParameter("users", user_id);
